...
#print(fixLabels(['apples', 2.00, 0.99, 'bananas']))
#print(fixLabels([2.99, 5.49, 'chocolate', 1.99, 'ice cream', 'candy', 4.0]))
...
def smashBros(fighterList, opponent):
    ...
    for fighter in fighterList:
        if fighter in smashData.counterPick(opponent):
...
#print(smashBros(['mewtwo', 'kirby', 'link', 'pikachu'], 'mewtwo'))
